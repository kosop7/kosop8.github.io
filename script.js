...
class DragonBallZGame {
    ...
    setupEventListeners() {
        ...
        this.canvas.addEventListener('click', handleUserInput);
        this.canvas.addEventListener('touchstart', handleUserInput);
    ...
    createScenes() {
        ...
        this.scenes.push({
            ...
            dialogue: [
                { speaker: '안드로이드 16호', text: '내가 좋아했던' },
                { speaker: '안드로이드 16호', text: '자연과 동물들을…' },
                { speaker: '안드로이드 16호', text: '지.켜.주.거.라.' },
                { speaker: '안드로이드 16호', text: '부탁한다~' }
            ]
        });
        ...
        this.scenes.push({
            ...
            dialogue: [
                { speaker: '셀', text: '쓸데없는 참견이다.' },
                { speaker: '셀', text: '실패작 녀석.' }
            ]
        });
        ...
        this.scenes.push({
            ...
            camera: { x: 0, y: 0, zoom: 2 },
            dialogue: [
                { speaker: '내레이션', text: '드디어... 오반의 분노의 한계가 넘은 것인가?' }
            ]
        });
